...
> Clink是一个面向Windows的替代/扩展版本的cmd.exe shell，它将GNU Readline风格的功能引入Windows命令提示符。它与现有的cmd.exe进程集成，提供增强的编辑、历史记录、补全和脚本功能，使Windows命令行的行为更接近Unix风格的shell。 [GPT-4o mini]
