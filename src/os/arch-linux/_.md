...
1. [pacman.md](/bin/_arch/pacman.md)
...
- [Domain_name_resolution.md](/os/arch/Domain_name_resolution.md)
- [Install_fonts.md](/os/arch/Install_fonts.md)
- [Users_and_groups.md](/os/arch/Users_and_groups.md)

- [appimage.md](/os/arch/appimage.md)

### cache

- [rasparch.md](/os/arch/rasparch.md)
- [xdg-base-directory.md](/os/arch/xdg-base-directory.md)
- [xorg.md](/os/arch/xorg.md)
