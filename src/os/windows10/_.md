...
SCOOP_GLOBAL=C:\Users\User\Scoop
```
...
del "%SendTo%\yoga.bat"
mklink "%SendTo%\7zFM.exe" "%SCOOP%\apps\7zip\current\7zFM.exe"
mklink "%SendTo%\WinMergeU.exe" "%SCOOP%\apps\winmerge\current\WinMergeU.exe"
mklink "%SendTo%\video-compare.exe" "%SCOOP%\apps\video-compare\current\video-compare.exe"
