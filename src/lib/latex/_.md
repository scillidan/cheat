...
- #blog
	...
	- [Using Tiled hexmaps in LaTeX](https://vladar.bearblog.dev/using-tiled-hexmaps-in-latex/)
...
- [A simple LaTeX template to print Magic: the Gathering cards as PDF](https://github.com/Naereen/LaTeX_template_to_print_Magic_cards/)
