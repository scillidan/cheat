# [make4ht](https://www.ctan.org/pkg/make4ht)
...
译：make4ht是一个用于TEX4ht的构建系统，TEX到XML的转换器。它提供了一个命令行工具来驱动转换过程。它还提供了一个库，可以用来创建自定义的转换工具。这样的工具的一个例子是tex4ebook，它是用于将TEX转换为ePub及其他电子书格式的工具。